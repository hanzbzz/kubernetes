...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1.ContainerCheckpointOptions)(nil), (*core.ContainerCheckpointOptions)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_ContainerCheckpointOptions_To_core_ContainerCheckpointOptions(a.(*v1.ContainerCheckpointOptions), b.(*core.ContainerCheckpointOptions), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.ContainerCheckpointOptions)(nil), (*v1.ContainerCheckpointOptions)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_ContainerCheckpointOptions_To_v1_ContainerCheckpointOptions(a.(*core.ContainerCheckpointOptions), b.(*v1.ContainerCheckpointOptions), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*url.Values)(nil), (*v1.ContainerCheckpointOptions)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_url_Values_To_v1_ContainerCheckpointOptions(a.(*url.Values), b.(*v1.ContainerCheckpointOptions), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_ContainerCheckpointOptions_To_core_ContainerCheckpointOptions(in *v1.ContainerCheckpointOptions, out *core.ContainerCheckpointOptions, s conversion.Scope) error {
	...
	out.LeaveRunning = (*bool)(unsafe.Pointer(in.LeaveRunning))
	out.Encrypt = (*bool)(unsafe.Pointer(in.Encrypt))
	out.EncryptionSecret = in.EncryptionSecret
	out.EncryptionCert = in.EncryptionCert
	return nil
}

// Convert_v1_ContainerCheckpointOptions_To_core_ContainerCheckpointOptions is an autogenerated conversion function.
func Convert_v1_ContainerCheckpointOptions_To_core_ContainerCheckpointOptions(in *v1.ContainerCheckpointOptions, out *core.ContainerCheckpointOptions, s conversion.Scope) error {
	return autoConvert_v1_ContainerCheckpointOptions_To_core_ContainerCheckpointOptions(in, out, s)
}
...
// Convert_core_ContainerCheckpointOptions_To_v1_ContainerCheckpointOptions is an autogenerated conversion function.
func Convert_core_ContainerCheckpointOptions_To_v1_ContainerCheckpointOptions(in *core.ContainerCheckpointOptions, out *v1.ContainerCheckpointOptions, s conversion.Scope) error {
	return autoConvert_core_ContainerCheckpointOptions_To_v1_ContainerCheckpointOptions(in, out, s)
}

func autoConvert_url_Values_To_v1_ContainerCheckpointOptions(in *url.Values, out *v1.ContainerCheckpointOptions, s conversion.Scope) error {
	...
	if values, ok := map[string][]string(*in)["leaveRunning"]; ok && len(values) > 0 {
		if err := runtime.Convert_Slice_string_To_Pointer_bool(&values, &out.LeaveRunning, s); err != nil {
			return err
		}
	} else {
		out.LeaveRunning = nil
	}
	if values, ok := map[string][]string(*in)["encrypt"]; ok && len(values) > 0 {
		if err := runtime.Convert_Slice_string_To_Pointer_bool(&values, &out.Encrypt, s); err != nil {
			return err
		}
	} else {
		out.Encrypt = nil
	}
	if values, ok := map[string][]string(*in)["encryptionSecret"]; ok && len(values) > 0 {
		if err := runtime.Convert_Slice_string_To_string(&values, &out.EncryptionSecret, s); err != nil {
			return err
		}
	} else {
		out.EncryptionSecret = ""
	}
	if values, ok := map[string][]string(*in)["encryptionCert"]; ok && len(values) > 0 {
		if err := runtime.Convert_Slice_string_To_string(&values, &out.EncryptionCert, s); err != nil {
			return err
		}
	} else {
		out.EncryptionCert = ""
...
// Convert_url_Values_To_v1_ContainerCheckpointOptions is an autogenerated conversion function.
func Convert_url_Values_To_v1_ContainerCheckpointOptions(in *url.Values, out *v1.ContainerCheckpointOptions, s conversion.Scope) error {
	return autoConvert_url_Values_To_v1_ContainerCheckpointOptions(in, out, s)
}
